...
<%
	...
	String sqlStmt = "SELECT c.* FROM course_info as c JOIN enrollment_info as e ON c.course_no=e.course_no AND e.user_id=?";
	...
	*/
	...
	if (!rs.next()) {
		out.println("<P> You haven't enrolled any courses! No course can be dropped.");
	} else {
%>	
